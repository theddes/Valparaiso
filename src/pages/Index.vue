...
<script>
    ...
    export default {
        name: 'Index',
        components: { ValpoSplash, ValpoContent, ValpoButton, ValpoList, ValpoListItem },
        data: () => ({
            involved: [
                {
...
<style lang="scss" scoped>
    ...
    .involved {
        background: var(--color-ocean) url('../assets/images/image-hand.jpg') no-repeat top center;
