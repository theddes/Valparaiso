...
<script>
    ...
    export default {
        ...
        mounted () {
            ...
            this.cached = localStorage.getItem('valparaiso') !== null && localStorage.getItem('last_updated') !== null && days < this.$_config.data.preserve
        ...
        methods: {
            updateData () {
                this.$_firebase.database().ref('site').once('value').then(snapshot => {
